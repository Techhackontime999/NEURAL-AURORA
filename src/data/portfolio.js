...
export const services = [
  {
    ...
    delivery: '2-3 weeks',
    pricing: [
      { label: 'Landing Page', price: '1.5k', price_paise: 150000, delivery: '1 week', features: ['Single page', 'Basic SEO', 'Contact form', 'Responsive design'] },
      { label: 'Multi-Page App', price: '2.5k', price_paise: 250000, delivery: '2-3 weeks', features: ['Up to 5 pages', 'API integration', 'Dashboard', 'CMS integration'] },
      { label: 'E-commerce', price: '5k', price_paise: 500000, delivery: '3-5 weeks', features: ['Product catalog', 'Cart & checkout', 'Payment gateway', 'Admin panel'] },
      { label: 'Custom Web App', price: '10k', price_paise: 1000000, delivery: '4-8 weeks', features: ['Full custom build', 'Database design', 'Authentication', 'Admin dashboard'] },
    ],
    display_order: 0,
  },
  {
    ...
    delivery: '1-2 weeks',
    pricing: [
      { label: 'UI Audit', price: '0.8k', price_paise: 80000, delivery: '3-5 days', features: ['Heuristic review', 'Accessibility audit', 'Improvement report', 'User flow analysis'] },
      { label: 'Wireframe & Prototype', price: '1.5k', price_paise: 150000, delivery: '1-2 weeks', features: ['Low-fi wireframes', 'High-fi mockups', 'Interactive prototype', 'User testing'] },
      { label: 'Design System', price: '3k', price_paise: 300000, delivery: '2-3 weeks', features: ['Component library', 'Style tokens', 'Documentation', 'Figma source files'] },
      { label: 'Full Product Design', price: '6k', price_paise: 600000, delivery: '3-6 weeks', features: ['Research & strategy', 'UX architecture', 'Visual design', 'Dev handoff'] },
    ],
    display_order: 1,
  },
  {
    ...
    delivery: '2-5 days',
    pricing: [
      { label: 'Code Review', price: '3k', price_paise: 300000, delivery: '2-3 days', features: ['Full code audit', 'Performance analysis', 'Security check', 'Actionable report'] },
      { label: 'Architecture Consult', price: '5k', price_paise: 500000, delivery: '3-5 days', features: ['Stack evaluation', 'System design review', 'Migration strategy', 'Roadmap planning'] },
      { label: 'Team Workshop', price: '8k', price_paise: 800000, delivery: '1 week', features: ['Custom curriculum', 'Live sessions', 'Code exercises', 'Follow-up materials'] },
      { label: 'Fractional CTO', price: '15k', price_paise: 1500000, delivery: 'Monthly', features: ['Ongoing guidance', 'Team management', 'Technical decisions', 'Monthly review'] },
    ],
    display_order: 2,
  },
  {
    ...
    delivery: '4-8 weeks',
    pricing: [
      { label: 'MVP Development', price: '5k', price_paise: 500000, delivery: '3-5 weeks', features: ['Core features only', 'Rapid prototyping', 'Iterative builds', 'Market-ready launch'] },
      { label: 'Full Product', price: '10k', price_paise: 1000000, delivery: '6-10 weeks', features: ['Complete build', 'Scalable architecture', 'Testing & QA', 'Deployment'] },
      { label: 'Integration', price: '4k', price_paise: 400000, delivery: '1-3 weeks', features: ['Third-party APIs', 'Legacy system bridge', 'Data migration', 'Testing'] },
      { label: 'Maintenance', price: '2k', price_paise: 200000, delivery: 'Monthly', features: ['Bug fixes', 'Updates & patches', 'Monitoring', 'Priority support'] },
    ],
    display_order: 3,
  },
]
  ...
  future_releases: [
    {
      id: 'pro',
      icon_name: 'Zap',
      title: 'Neural Aurora Pro',
      tagline: 'Advanced features for power users',
      description: 'Priority support, AI automation, white-label mode, custom integrations, and advanced analytics tailored for professionals who need more.',
      color: 'from-cyan-500 to-purple-500',
    },
    {
      id: 'teams',
      icon_name: 'Users',
      title: 'Neural Aurora for Teams',
      tagline: 'Collaborative portfolio infrastructure',
      description: 'Multi-user editing, team workspaces, shared asset library, role-based access control, and version history for your entire team.',
      color: 'from-emerald-500 to-teal-500',
    },
    {
      id: 'enterprise',
      icon_name: 'Building2',
      title: 'Neural Aurora Enterprise',
      tagline: 'Self-hosted, fully customizable',
      description: 'On-premise deployment, custom branding, SLA-backed support, advanced security compliance, and dedicated infrastructure.',
      color: 'from-amber-500 to-orange-500',
    },
    {
      id: 'cloud',
      icon_name: 'Cloud',
      title: 'Neural Aurora Cloud',
      tagline: 'Managed platform for everyone',
      description: 'One-click deploy, automatic updates, global CDN, built-in monitoring, usage analytics, and scalable cloud infrastructure.',
      color: 'from-blue-500 to-indigo-500',
    },
    {
      id: 'business',
      icon_name: 'Briefcase',
      title: 'Neural Aurora for Business',
      tagline: 'Grow your agency with white-label',
      description: 'Client-ready white-label portfolio builder, multi-tenant management, branded subdomains, bulk invoicing, and team collaboration tools.',
